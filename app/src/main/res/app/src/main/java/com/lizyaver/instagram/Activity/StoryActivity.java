...
import com.lizyaver.instagram.library.StoriesProgressView;
...
public class StoryActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seen_username = findViewById(R.id.seen_number);
    ...
    private void addView(String storyids){
        FirebaseDatabase.getInstance().getReference("Story").child(userid)
                .child(storyids).child("views").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(true);
    }
    ...
    private void seenNumber(String storyids){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                seen_username.setText(""+snapshot.getChildren());
            }
